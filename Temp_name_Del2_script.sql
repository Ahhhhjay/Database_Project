...
TASK_NUM CHAR(6) CONSTRAINT ASSIGNMENT_TASK_NUM_FK FOREIGN KEY (TASK_NUM) REFERENCES TASK,
...
PACKAGE_NUM CHAR(6) CONSTRAINT CONTENTS_PACKAGE_NUM_FK FOREIGN KEY (PACKAGE_NUM) REFERENCES PACKAGE,
ITEM_ID CHAR(6) CONSTRAINT CONTENTS_ITEM_ID_FK FOREIGN KEY (ITEM_ID) REFERENCES ITEM,
...
INCREMENT BY 1;
--CREATING INDEXES
CREATE INDEX VOLUNTEER_FNAME_INDX ON VOLUNTEER(FNAME);

CREATE INDEX ITEM_VALUE_INDX ON ITEM(ITEM_VALUE);
